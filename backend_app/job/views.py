...
class JobViewSet(viewsets.ModelViewSet):
    ...
    def monthly_post_percentage(self, request):
        ...
        if total_posts == 0:
            return Response({"message": "No job posts available for the current year."})
        ...
        return Response(data_with_percentage)

    # Ensure job title uniqueness and handle validation properly
